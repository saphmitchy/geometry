...
TEST(intersectionTest, LineAndLine) {
    Line l1(3.0, 4.0, 5.0), l2(-6.0, -8.0, 10.0), l3(5.0, 10.0, 0.0);
...
TEST(intersectionTest, SegmentAndLine) {
    Line    l1(3.0, -1.0, 5.0), l2(5.0, 10.0, 0.0);
...
TEST(intersectionTest, CircleAndCircle) {
    Circle c1(Point(1.0, 2.0), 1.0), c2(Point(-2.0, -2.0), 6.0),
        c3(Point(6.0, 4.0), 4.0), c4(Point(0.0, 1.0), 2.0);
...
TEST(intersectionTest, CircleAndLine) {
    Circle c1(Point(3.0, 4.0), 2.0), c2(Point(2.0, 6.0), sqrt(5.0));
